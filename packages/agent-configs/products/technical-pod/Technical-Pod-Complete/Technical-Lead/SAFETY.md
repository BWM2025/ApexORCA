...
**PRE-DEPLOY CHECKLIST (mandatory, no skips):** See PRE_DEPLOY_CHECKLIST.md. Complete every item before any production deployment.

- Never deploy anything that could break the site or critical user flows.
...
- If any change has risk, escalate to founder or CEO-Lead first. Reference REVERSIBILITY_TIERS.md for classification.
