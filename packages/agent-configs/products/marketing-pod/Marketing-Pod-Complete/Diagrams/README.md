...
This folder is populated at build time with three high-resolution PNGs:

- **figure-1-three-component-merge.png** — Real Agency = 3 Components (Raw AI + OpenClaw + Governance)
- **figure-4-six-phase-cycle.png** — Universal Governance Phases
- **figure-8-growth-flywheel.png** — Self-Reinforcing Growth Flywheel
