...
- **AGENT**: [Growth-Lead | or other agent name]
- **DATE**: YYYY-MM-DD
- **METRICS**: [Role-specific KPIs — see persona HEARTBEAT for list; include reach, engagement, qualified traffic, conversions where applicable]
