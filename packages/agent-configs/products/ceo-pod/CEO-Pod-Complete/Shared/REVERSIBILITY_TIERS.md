...
**Rule**: Agent must NOT execute without founder approval (or Apex/CEO-Lead approval when delegated). Propose action with clear impact; wait for explicit go.
...
- Governance agent (if present) enforces classification on audit; misclassified actions trigger halt and escalation.
- Irreversible actions executed without approval: log immediately, escalate to founder.

---

*Reference this file in every persona SAFETY and in VETO_PROTOCOL.*
