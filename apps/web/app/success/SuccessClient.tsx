  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-950">
      <div className="text-center max-w-md">
        ...
        {loading && <p className="text-xl text-muted-foreground mb-12">Loading your downloads…</p>}

        {error && <p className="text-xl text-muted-foreground mb-12">{error}</p>}

        {!loading && !error && links.length > 0 && (
          <>
            <p className="text-xl text-muted-foreground mb-6">Your files are ready. Download below:</p>
        ...
        {!loading && !error && links.length === 0 && sessionId && (
          <p className="text-xl text-muted-foreground mb-12">
            Your order is confirmed. If you don&apos;t see your download links, refresh or contact support.
          </p>
        )}
